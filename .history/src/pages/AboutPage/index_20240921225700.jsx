...
import {listmission} from '../../constants/aboutpage'
...
<div className="container mx-auto px-4">
  ...
  <div className="pb-[12rem]">
    ...
    <div>
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-[5rem]" style={{ borderRadius: '10px' }}>
  ...
  {locations.map((inf, index) => (
          <div key={index} className="text-center p-4 rounded-lg" style={{background: '#365fbf'}}>
            <h2 className="text-3xl text-white font-bold">{inf.location}</h2>
            <p className="text-white mt-4">{inf.title}</p>
          </div>
        ))}
