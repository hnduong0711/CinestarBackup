                            ...
                            <div key={info.id} className="text-left p-4 bg-custom-gradient space-y-4">
                                ...
                                {info.room && (
                                    <p className="flex items-center text-white font-content">
                                        <img src="https://cinestar.com.vn/assets/images/ic-branch-room.svg" alt="" />
                                        <a href="#" className="text-white" onClick={(e) => e.preventDefault()}>{info.room}</a>
                                    </p>
                                )}

                                <a href={info.map} target="_blank" rel="noopener noreferrer">
                                    <p className={`flex items-center text-white font-content  ${info.id > 1 ? 'underline tracking-[0.05em]' : ''}`}>
                                ...
                                {info.email && (
                                    <p className="flex items-center text-white font-content">
                                        ...
                                        <a href={info.email} className={`text-white underline tracking-[0.05rem] ${info.id === 1 ? '' : 'no-underline'}`}>{info.emailContent}</a>
                                    </p>
                                )}
                                ...
                                {info.numberphone && (
                                    <p className="flex items-center text-white font-content">
                                        ...
                                        <a href={info.phone} className="text-white">{info.numberphone}</a>
                                    </p>
                                )}
                            </div>
                        ))}
