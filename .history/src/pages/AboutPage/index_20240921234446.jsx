...
<div className="container mx-auto px-4">
  ...
  <div className="relative">
    <div className="absolute inset-0 rounded-lg pt-14 pb-20 pr-10 pl-10"></div>
    <img
    ...
    />
    <div className="absolute inset-0 bg-black bg-opacity-60 rounded-lg" style={{ margin: '43px 40px 80px 40px' }}></div>
