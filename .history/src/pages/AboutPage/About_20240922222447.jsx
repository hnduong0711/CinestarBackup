        ...
        <div className="absolute inset-0 flex flex-col justify-center text-white pl-[5rem]">
          <ul className="text-left">
            ...
            <li className="flex items-center mb-2">
              <img src="https://cinestar-api.monamedia.net/pub/template/assets/images/ts-1.svg" alt="" className='w-[2rem] mr-1' />
              <a href='https://maps.app.goo.gl/d7S3pWtnwCc7P2Dy5' target='_blank'><span>135 Hai Bà Trưng, Phường Bến Nghé, Quận 1</span></a>
            </li>

            {/* Email */}
            <li className="flex items-center mb-2">
              <img src="https://cinestar-api.monamedia.net/pub/template/assets/images/ts-2.svg" alt="" className='w-[2rem] mr-1' />
