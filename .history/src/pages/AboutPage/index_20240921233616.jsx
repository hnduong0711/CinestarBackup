...
<div className="container mx-auto px-4">
  ...
  <div className="pb-[6rem]">
    ...
    <div>
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8" style={{ borderRadius: '10px' }}>'Josefin Sans', 'sans-serif'
        {listmission.map((mission, index) => (
          <div key={index} className="text-center p-4 rounded-lg" style={{background: '#365fbf'}}>
            <h2 className="text-[34px] font-antons text-white font-bold" style={{color: '#f3ea28', fontFamily: 'Josefin Sans, sans-serif'}}>{mission.title}</h2>
