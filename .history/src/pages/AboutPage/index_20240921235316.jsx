...
<div className="container mx-auto px-4">
  ...
  <div className="relative pt-14 pb-10 pr-10 pl-10">
  <div className="absolute inset-0 rounded-lg overflow-hidden">
    ...
    />
    <div className="absolute inset-0 bg-black bg-opacity-40 rounded-lg"></div> {/* Thêm lớp phủ tối */}
  </div>
  
  <div className="absolute inset-0 flex items-center justify-center">
    <div className="text-white text-center p-6 bg-black bg-opacity-60 rounded-lg"> {/* Thay đổi opacity để tạo độ tương phản tốt hơn */}
      <h1 className="text-2xl font-bold mb-4 font-black text-[#f8fafc]">
        HỆ THỐNG CỤM RẠP TRÊN TOÀN QUỐC
      </h1>
      <p className="text-base px-4 md:px-10"> {/* Thay đổi padding cho đồng đều hơn */}
