      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 flex flex-col items-left justify-center text-white">
          <ul className="text-white text-left pl-[5rem]">
              ...
              <li className="flex items-center"> {/* Flex container to align icon and text */}
                <img src={iconMap} alt="IconMap" className='w-[2rem] mr-2' /> {/* Icon with margin-right */}
                <span>135 Hai Bà Trưng, Phường Bến Nghé, Quận 1</span>
              </li>
              
              <li className="mt-2"><a>marketing.cinestar@gmail.com</a></li>
              <li className="mt-2"><a>marketing.cinestar@gmail.com</a></li>
</ul>
