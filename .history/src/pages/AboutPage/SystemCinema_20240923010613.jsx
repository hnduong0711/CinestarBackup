                ...
                <div className="w-1/2 p-4">
                    ...
                    {imformation.map((info) => (
                        <div key={info.id} className="text-left p-4 bg-custom-gradient space-y-4">
                            ...
                            {info.room && (
                            <p className="flex items-center text-white font-content mb-4">
                            ...
                            <p className={`flex items-center text-white font-content hover:text-cinestar-gold mb-4 ${info.id > 1 ? 'underline underline-offset-4' : ''}`}>
