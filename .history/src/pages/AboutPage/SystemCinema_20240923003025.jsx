                    ...
                    {imformation.map((info) => (
                            <div key={info.id} className="text-left p-4 bg-custom-gradient space-y-4">
                                ...
                                <a href={info.map} target="_blank" rel="noopener noreferrer">
                                    <p className={`flex items-center text-white font-content  ${info.id > 1 ? 'underline tracking-[0.1em]' : ''}`}>
                                ...
                                {info.email && (
                                    <p className="flex items-center text-white font-content">
                                        ...
                                        <a href={info.email} className={`text-white underline tracking-[0.1rem] ${info.id === 1 ? '' : 'no-underline'}`}>{info.emailContent}</a>
                                    </p>
                                )}
