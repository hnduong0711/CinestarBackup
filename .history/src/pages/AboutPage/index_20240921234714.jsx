...
<div className="container mx-auto px-4">
  ...
  <div className="relative pt-14 pb-10 pr-5 pl-5">
  <div className="absolute inset-0 rounded-lg overflow-hidden">
    <img
      src="https://api-website.cinestar.com.vn/media/wysiwyg/CMSPage/Abouts/ht-qc-br.jpg"
      alt="Image description"
      className="w-full h-[350px] md:h-[450px] object-cover transition-transform duration-300 hover:scale-105"
    />
    <div className="absolute inset-0 bg-black bg-opacity-60"></div>
  </div>
  <div className="absolute inset-0 flex items-center justify-center p-6">
    <div className="text-white text-center bg-black bg-opacity-40 rounded-lg p-6">
      <h1 className="text-3xl font-bold mb-4 text-[#f8fafc]">HỆ THỐNG CỤM RẠP TRÊN TOÀN QUỐC</h1>
      <p className="text-base px-4 md:px-10">
