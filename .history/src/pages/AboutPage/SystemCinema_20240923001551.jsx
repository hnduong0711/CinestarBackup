                    ...
                    <div className='grid grid-cols-1 md:grid-cols-1 gap-8'>
                          ...
                          {imformation.map((info) => (
                            <div key={info.id} className="text-left p-4 bg-custom-gradient space-y-4">
                                ...
                                <p className="text-white font-content"><img src="https://cinestar-api.monamedia.net/pub/template/assets/images/ts-1.svg" alt="" className='w-[25px] mr-2' /> {info.address}</p>
                                </a>
                                <p className="text-white font-content">
                                <img src="https://cinestar-api.monamedia.net/pub/template/assets/images/ts-2.svg" alt="" className='w-[25px] mr-2' /> <a href={info.email} className="text-blue-300">marketing.cinestar@gmail.com</a>
                                </p>
                                <p className="text-white font-content">
                                <img src="https://cinestar-api.monamedia.net/pub/template/assets/images/ts-3.svg" alt="" className='w-[25px] mr-2' /> <a href={info.phone} className="text-blue-300">{info.numberphone}</a>
                                </p>
                            </div>
                            ))}
                    </div>
