                ...
                <div className="flex">
                    ...
                    {/* Div thứ hai chiếm 40% */}
                        <div className="flex-grow-[4] w-[40%]">
                            <div className="flex">
                                <div className="flex-grow-[6] w-[50%] text-white font-content">Tạm tính</div>
                                <div className="flex-grow-[6] w-[60%] text-r text-white font-content text-[30px]">20.000 Đ</div>
                            </div>
                        </div>
                    </div>
                </div>
