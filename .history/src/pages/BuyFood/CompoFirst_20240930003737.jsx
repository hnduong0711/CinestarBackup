...
const ListCombo = ({ onSelectCombos }) => {
    ...
    const handleQuantityChange = (id, value) => {
        ...
        updateSelectedCombos(id, newValue - (prev[id] || 0));
    };

    const updateSelectedCombos = (id, change) => {
                ...
                if (existing) {
                    if (existing.quantity + change <= 0) {
                        ...
                        return prev.map((combo) =>
                            combo.id === food.id
                                ? { ...combo, quantity: existing.quantity + change }
                                : combo
                        );
                    }
                } else {
                    return [...prev, { ...food, quantity: change }];
                }
            });
        }
    };
                        ...
                        <div key={category} className="mb-8">
                            ...
                            <div className="flex flex-wrap justify-center">
                                {groupcomboFoods[category].map((food) => {
                                    return (
                                        <div key={food.id} className="flex items-stretch mb-4 w-1/3 group pb-10">
                                                ...
                                                <div className="flex mt-12 pl-[15px]">
                                                    <div className="group cursor-default flex hover:bg-cinestar-custom-yellow ">
                                                        ...
                                                        <input
                                                            ...
                                                            className="text-center w-[30px] h-[30px] bg-gray-300 group-hover:bg-cinestar-custom-yellow cursor-default"
