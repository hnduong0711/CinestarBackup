                ...
                <div className="flex">
                    ...
                    {/* Div thứ hai chiếm 40% */}
                        <div className="flex-grow-[4] w-[40%] pr-15">
                            ...
                            <div>
                            <Button
                                    className="button md:button w-[400px] h-[40px] text-white hidden group items-center font-content border border-solid border-white bg-oragan-yellow-gradient"
                                    text="THANH TOÁN"
                                />
                            </div>
                        </div>
