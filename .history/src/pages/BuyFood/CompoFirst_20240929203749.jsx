                        ...
                        <div key={category} className="mb-8">
                            ...
                            <div className="flex flex-wrap justify-center">
                                {groupcomboFoods[category].map((food) => {
                                    return (
                                        <div key={food.id} className="flex items-stretch mb-4 w-1/3 group pb-20"> {/* Thêm class group tại đây */}
                                            ...
                                            <div>
                                                ...
                                                <div className="flex mt-12 pl-[15px] ">
                                                    <button 
                                                        className="bg-gray-300 text-black w-[30px] p-1 rounded-l" 
                                                    ...
                                                    <input 
                                                        ...
                                                        className="text-center w-[80px] border border-gray-300 bg-gray-300"
                                                        style={{ appearance: 'none', MozAppearance: 'textfield', WebkitAppearance: 'none' }} // Loại bỏ các mũi tên
                                                    />
                                                    <button 
                                                        className="bg-gray-300 text-black w-[30px] p-1 rounded-r" 
