                                        ...
                                        <div key={food.id} className="flex items-stretch mb-4 w-1/3 group pb-10"> {/* Thêm class group tại đây */}
                                            ...
                                            <div>
                                                ...
                                                <div className="flex mt-12 pl-[15px]"> {/* Thêm class group và hover:bg-yellow-500 */}
                                                    <div className="group hover:bg-yellow-500 flex">
                                                        <button 
                                                            className="bg-gray-300 text-black w-[30px] h-[30px] p-1 rounded-l group-hover:bg-yellow-500"
                                                        ...
                                                        <input 
                                                            ...
                                                            className="text-center w-[30px] h-[30px] bg-gray-300 group-hover:bg-yellow-500" // Đặt kích thước bằng với nút
                                                            style={{ appearance: 'none', MozAppearance: 'textfield', WebkitAppearance: 'none', border: 'none' }} // Bỏ border và các mũi tên
                                                        />
                                                        <button 
                                                            className="bg-gray-300 text-black w-[30px] h-[30px] p-1 rounded-r group-hover:bg-yellow-500"
