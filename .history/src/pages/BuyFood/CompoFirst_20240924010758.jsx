                                    ...
                                    return (
                                        <div key={food.id} className="flex items-stretch mb-4 w-1/3 group"> {/* Thêm class group tại đây */}
                                            ...
                                            <div className="flex-grow text-left ml-4 flex flex-col"> {/* Căn giữa nội dung */}
                                                <h4 className="font-medium text-[16px] text-white text-[18px] transition-colors duration-300 group-hover:text-yellow-500">{food.title.toUpperCase()}</h4>
                                                <p className="text-white text-[16px] transition-colors duration-300 ">{food.content}</p>
