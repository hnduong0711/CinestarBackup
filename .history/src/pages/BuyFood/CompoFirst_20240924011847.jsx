                                    ...
                                    return (
                                        <div key={food.id} className="flex items-stretch mb-4 w-1/3 group"> {/* Thêm class group tại đây */}
                                            <div className="bg-[#ecf0f1] w-[184px] flex items-center justify-center relative overflow-hidden h-full">
                                                ...
                                                <div>
                                                    <div key={food.id} className="flex items-stretch mb-4 w-1/3">
                                                        <div className="bg-[#ecf0f1] w-[184px] flex items-center justify-center relative overflow-hidden group h-full">
                                                            <div className="relative">
                                                                <img 
                                                                    src={food.img} 
                                                                    alt={food.title} 
                                                        ...
                                                        <div className="flex-grow text-left ml-4 flex flex-col justify-between items-end"> {/* Thêm items-end vào đây */}
