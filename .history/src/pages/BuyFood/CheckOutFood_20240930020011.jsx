                ...
                <div className="flex">
                    ...
                    {/* Div thứ hai chiếm 40% */}
                        <div className="flex-grow-[4] w-[40%] pr-15">
                            ...
                            <div>
                            <Button
                                className="relative group bg-cinestar-black w-[400px] h-[40px] text-white items-center font-content border border-solid border-white overflow-hidden"
                                text="THANH TOÁN"
                            >
                                <span className="relative z-10">THANH TOÁN</span>
                                <div className="absolute inset-0 bg-gradient-to-r from-orange-400 to-yellow-500 transform -translate-x-full transition-transform duration-500 group-hover:translate-x-0"></div>
                            </Button>
