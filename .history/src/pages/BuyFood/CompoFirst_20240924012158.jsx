                                            ...
                                            <div className="bg-[#ecf0f1] w-[184px] flex items-center justify-center relative overflow-hidden h-full">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="flex mt-12 pl-[15px]">
                                                        <button className="bg-gray-300 w-[30px] text-black p-1 rounded-l" onClick={() => handleDecrease(food.id)}>-</button>
                                                        <input 
                                                            type="number" 
                                                            min="1" 
                                                            value={quantities[food.id] || 1} 
                                                            onChange={(e) => handleQuantityChange(food.id, e.target.value)} 
                                                            className="text-center w-[80px] border border-gray-300" 
                                                        />
                                                        <button className="bg-gray-300 w-[30px] text-black p-1 rounded-r" onClick={() => handleIncrease(food.id)}>+</button>
                                                    </div>
                                                </div>
                                        </div>
                                    );
