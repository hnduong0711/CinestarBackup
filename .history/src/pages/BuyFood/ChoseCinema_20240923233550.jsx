...
const ChoseCinema = () => {
    ...
    <div>
        ...
        <div>
         ...
         <select id="cinestar" value={selectedCinema} onChange={handleCinestarChange} className="border border-gray-300 rounded p-2 bg-white w-[200px] h-[50px]s">
            {choseLocationNears.map((choseLocationNear) => (
                <option key={choseLocationNear.id} value={choseLocationNear.value}>{choseLocationNear.titletoUpperCase()}</option>
            ))}
         </select>
