...
const ChoseCinema = () => {
    ...
    const { setSelectedCinema } = useContext(CinemaContext);
   ...
   const handleCinestarChange = (event) => {
    ...
    return (
        <div>
            ...
            <select onChange={handleCinestarChange} className="border border-gray-300 rounded p-2 bg-white w-[850px] h-[62px] text-[25px] font-title font-medium tracking-[0.09em]">
