...
const ChoseCinema = () => {
    ...
    <div>
        ...
        <div>
         ...
         <select id="cinestar" value={selectedCinema} onChange={handleCinestarChange} className="border border-gray-300 rounded p-2 bg-white w-[1000px] h-[62px] text-[20px] font-title font-medium">
