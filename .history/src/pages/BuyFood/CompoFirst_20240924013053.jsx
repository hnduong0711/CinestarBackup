                                        ...
                                        <div key={food.id} className="flex items-stretch mb-4 w-1/3 group"> {/* Thêm class group tại đây */}
                                            <div className="bg-[#ecf0f1] w-[184px] flex items-center justify-center relative overflow-hidden h-full">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="flex mt-12 pl-[15px] group">
                                                        <button 
                                                            className="bg-cinestar-button-food w-[30px] text-black p-1 rounded-l group-hover:cinestar-button-food-hover" 
                                                        ...
                                                        <input 
                                                            ...
                                                            className="text-center w-[80px] border border-cinestar-button-food bg-cinestar-button-food" 
                                                            style={{ appearance: 'none', MozAppearance: 'textfield' }} // Xóa button lên xuống
                                                        />
                                                        <button 
                                                            className="bg-cinestar-button-food w-[30px] text-black p-1 rounded-r group-hover:cinestar-button-food-hover" 
