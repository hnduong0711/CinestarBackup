                        ...
                        <div className="flex-grow-[4] w-[40%] pr-15">
                            ...
                            <div>
                                <Button
                                    ...
                                    className="button md:button bg-cinestar-black w-[400px] h-[40px] text-white hidden group-hover:flex items-center font-content border border-solid border-white"
                                    text="THANH TOÁN"
