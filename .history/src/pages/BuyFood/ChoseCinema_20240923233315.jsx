...
const ChoseCinema = () => {
    ...
    <div>
        ...
        <div>
         ...
         <select id="cinestar" value={selectedCinema} onChange={handleCinestarChange} className="border border-gray-300 rounded p-2 bg-white w-full">
            {choseLocationNears.map((choseLocationNear) => (
                <option className="uppercase" key={choseLocationNear.id} value={choseLocationNear.value}>{choseLocationNear.title}</option>
            ))}
         </select>
