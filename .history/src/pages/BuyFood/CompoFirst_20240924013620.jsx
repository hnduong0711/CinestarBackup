                                        ...
                                        <div key={food.id} className="flex items-stretch mb-4 w-1/3 group"> {/* Thêm class group tại đây */}
                                            <div className="bg-[#ecf0f1] w-[184px] flex items-center justify-center relative overflow-hidden h-full">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="flex mt-12 pl-[15px] hover:bg-yellow-500 transition-colors">
                                                        <button 
                                                            className="bg-gray-300 text-black w-[30px] p-1 rounded-l hover:bg-yellow-500 transition-colors duration-300" 
                                                        ...
                                                        />
                                                        <button 
                                                            className="bg-gray-300 text-black w-[30px] p-1 rounded-r hover:bg-yellow-500 transition-colors duration-300" 
