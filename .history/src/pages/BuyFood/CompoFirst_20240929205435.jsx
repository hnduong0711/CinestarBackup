                                        ...
                                        <div key={food.id} className="flex items-stretch mb-4 w-1/3 group pb-10"> {/* Thêm class group tại đây */}
                                            ...
                                            <div>
                                                <div className="flex-grow text-left ml-4 flex flex-col"> {/* Căn giữa nội dung */}
                                                    <h4 className="font-medium text-[16px] font-content text-white text-[18px] transition-colors duration-300 group-hover:bg-cinestar-custom-yellow">{food.title.toUpperCase()}</h4>
                                                ...
                                                <div className="flex mt-12 pl-[15px]"> {/* Thêm class group và hover:bg-yellow-500 */}
                                                    <div className="group hover:bg-cinestar-custom-yellow flex">
                                                        <button 
                                                            className="bg-gray-300 text-black w-[30px] h-[30px] group-hover:bg-cinestar-custom-yellow"
                                                        ...
                                                        <input 
                                                            ...
                                                            className="text-center w-[30px] h-[30px] bg-gray-300 group-hover:bg-cinestar-custom-yellow" // Đặt kích thước bằng với nút
